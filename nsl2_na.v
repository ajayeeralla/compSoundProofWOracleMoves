...
(if_then_else_M (EQ_M (to x1) (i 2)) & (EQ_M ( pi2 (dec x1 (sk (N 2)))) (pk (N 1))) (enc ( pi1 (dec x1 (sk (N 2)) ) , ((N 4) , (pk (N 2)))) ( pi2 (dec x1 (sk (N 2))))  (sr 2))  O)). 
...
Definition qa10 :=
 ...
 (if_then_else_M (EQ_M (to x2) (i 2))& (EQ_M ( pi2 (dec x2 (sk (N 2)))) (pk (N 1)))   (enc  ( pi1(dec x2 (sk (N 2)) ) , ((N 4) , (pk (N 2)))) ( pi2 (dec x2 (sk (N 2))))  (sr 4)) O)).
...
(if_then_else_M (EQ_M (to x1) (i 1)) & (EQ_M (act x1) new) 
qa10
(if_then_else_M (EQ_M (to x1) (i 2)) & (EQ_M ( pi2 (dec x1 (sk (N 2)))) (pk (N 1))) qa01  O)). 
...
Definition qa20 :=   (if_then_else_M (EQ_M (to  x3) (i 2))& (EQ_M ( pi2 (dec x3 (sk (N 2)))) (pk (N 1))) (enc ( pi1 (dec x3 (sk (N 2)) ) , ((N 4) , (pk (N 2)))) ( pi2 (dec x3 (sk (N 2))))   (sr 6))   O).
...
Definition qa10_s :=
 ...
 (if_then_else_M (EQ_M (to x2) (i 2))& (EQ_M ( pi2 (dec x2 (sk (N 2)))) (pk (N 1))) qa11 O)).
...
(if_then_else_M (EQ_M (to x1) (i 1)) & (EQ_M (act x1) new) 
qa10_s
(if_then_else_M (EQ_M (to x1) (i 2)) & (EQ_M ( pi2 (dec x1 (sk (N 2)))) (pk (N 1))) qa01_s  O)). 
...
(*
Definition qa30 := 
(if_then_else_M (EQ_M (to  x4) (i 2)) &(EQ_M (L (pi1 (dec x4 (sk (N 2))))) lnc)  (enc   ( pi1(dec x4 (sk (N 2)) ) , ( (nc 4) , (pk (N 2))))   (pi2  (dec x4 (sk (N 2)) )) (sr 9))  O ).
  *)
...
Definition qa20_s :=   (if_then_else_M (EQ_M (to  x3) (i 2))& (EQ_M ( pi2 (dec x3 (sk (N 2)))) (pk (N 1))) qa21  O).
...
Definition qa10_ss :=
 ...
 (if_then_else_M (EQ_M (to x2) (i 2))& (EQ_M ( pi2 (dec x2 (sk (N 2)))) (pk (N 1))) qa11_s O)).
...
(if_then_else_M (EQ_M (to x1) (i 1)) & (EQ_M (act x1) new) 
qa10_ss
(if_then_else_M (EQ_M (to x1) (i 2)) & (EQ_M ( pi2 (dec x1 (sk (N 2)))) (pk (N 1))) qa01_ss  O)). 
...
(*
Definition qa31 := (if_then_else_M (EQ_M (to x5) (i 2)) &(EQ_M  (dec x5 (sk (N 2))) (nc 4)) acc O).
*)

Definition qa22 := (if_then_else_M (EQ_M (reveal x5) (i 1)) (N 3) O).
(**************************************************************************************************************)
...
Definition qa20_ss :=   (if_then_else_M (EQ_M (to  x3) (i 2))& (EQ_M ( pi2 (dec x3 (sk (N 2)))) (pk (N 1))) qa21_s  O).
...
Definition qa10_sss :=
 ...
 (if_then_else_M (EQ_M (to x2) (i 2))& (EQ_M ( pi2 (dec x2 (sk (N 2)))) (pk (N 1))) qa11_ss O)).
...
(if_then_else_M (EQ_M (to x1) (i 1)) & (EQ_M (act x1) new) 
qa10_sss
(if_then_else_M (EQ_M (to x1) (i 2)) & (EQ_M ( pi2 (dec x1 (sk (N 2)))) (pk (N 1))) qa01_sss  O)). 



Definition phi5:= phi3 ++ [msg t16]. 
...
Definition qb22 := (if_then_else_M (EQ_M (reveal x5) (i 1)) & (EQ_M (m x1) (pk (N 2))) (N 14) (if_then_else_M (EQ_M (reveal x5) (i 1)) (N 3) O)).
...
Definition qb20_ss :=   (if_then_else_M (EQ_M (to  x3) (i 2))& (EQ_M ( pi2 (dec x3 (sk (N 2)))) (pk (N 1))) qb21_s  O).
...
Definition qb10_sss :=
 ...
 (if_then_else_M (EQ_M (to x2) (i 2))& (EQ_M ( pi2 (dec x2 (sk (N 2)))) (pk (N 1))) qb11_ss O)).
...
(if_then_else_M (EQ_M (to x1) (i 1)) & (EQ_M (act x1) new) 
qb10_sss
(if_then_else_M (EQ_M (to x1) (i 2)) & (EQ_M ( pi2 (dec x1 (sk (N 2)))) (pk (N 1))) qb01_sss  O)). 
