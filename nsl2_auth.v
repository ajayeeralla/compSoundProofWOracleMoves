...
(********************************************************************************)
(******protocol Pi1 :The oracle returns acc if there is a matching session *************)
...
(if_then_else_M (EQ_M (to x1) (i 2)) (enc ( pi1 (dec x1 (sk (N 2)) ) , ((N 4) , (pk (N 2)))) ( pi2 (dec x1 (sk (N 2))))  (sr 2))  O)). 
...
Definition qa10 :=
 ...
 (if_then_else_M (EQ_M (to x2) (i 2))  (enc  ( pi1(dec x2 (sk (N 2)) ) , ((N 4) , (pk (N 2)))) ( pi2 (dec x2 (sk (N 2))))  (sr 4)) O)).
...
Definition qa20 :=   (if_then_else_M (EQ_M (to  x3) (i 2)) (enc ( pi1 (dec x3 (sk (N 2)) ) , ((N 4) , (pk (N 2)))) ( pi2 (dec x3 (sk (N 2))))   (sr 6))   O).
...
Definition t14 := (if_then_else_M (EQ_M (to x1) (i 1)) & (EQ_M (act x1) new) qa10_s (if_then_else_M (EQ_M (to x1) (i 2)) qa01_s  O)). 
...
Definition t15 :=  (if_then_else_M (EQ_M (to x1) (i 1)) & (EQ_M (act x1) new) qa10_ss (if_then_else_M (EQ_M (to x1) (i 2)) qa01_ss  O)). 
...
Definition qa22 := (if_then_else_M (EQ_M (reveal x5) (i 2)) &(EQ_M  (dec x4 (sk (N 2))) (N 4)) &  (EQ_M   (pi1  (dec x2 (sk (N 1)))) (N 3)) &(EQ_M (pi2 (pi2 (dec x2 (sk (N 1))))) (m x1))  acc O).
...
Definition qa12_s := (if_then_else_M (EQ_M (to x4) (i 1)) & (EQ_M   (pi1  (dec x4 (sk (N 1)))) (N 3)) &(EQ_M (pi2 (pi2 (dec x4 (sk (N 1))))) (m x1))& (EQ_M  (dec x1 (sk (N 2))) ((N 3) , (pk (N 1)))) qa22 O) .
...
Definition t16 := (if_then_else_M (EQ_M (to x1) (i 1)) & (EQ_M (act x1) new) qa10_sss (if_then_else_M (EQ_M (to x1) (i 2)) qa01_sss  O)). 
...
(******************************************************************************************************************************************************)
(******************************************************************************************************************************************************)
(***********************protocol Pi2 : the oracle always returns acc************)
(*******************************************************************************)
...
Definition qb22 := (if_then_else_M (EQ_M (reveal x5) (i 2)) acc acc).
...
Definition t26 := (if_then_else_M (EQ_M (to x1) (i 1)) & (EQ_M (act x1) new) qb10_sss (if_then_else_M (EQ_M (to x1) (i 2)) qb01_sss  O)). 
